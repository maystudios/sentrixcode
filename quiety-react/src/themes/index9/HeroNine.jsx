...
const HeroNine = () => {
  ...
  return (
    <section
      ...
      style={{
        background: "url('/img/hero-9-img.png')no-repeat center center",
      }}
    >
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6">
            <div className="hero-img position-relative mt-5 mt-lg-0">
              ...
              />
              <div className="dots">
                <img src="/img/banner_dot.png" alt="dot" className="dot-1" />
                <img src="/img/banner_dot.png" alt="dot" className="dot-2" />
              </div>
