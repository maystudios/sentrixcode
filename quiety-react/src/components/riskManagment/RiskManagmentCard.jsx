          ...
          <div className="row">
            <div className="col-xxl-3 col-md-6">
              <div className="risk-info-card ca-two-border ca-two-border-color rounded-8 risk-border-hover padding-6 pt-40 mt-20">
                <img src="/img/risk_managment/info_card.svg" alt="" />
            ...
            <div className="col-xxl-3 col-md-6">
              <div className="risk-info-card ca-two-border ca-two-border-color rounded-8 risk-border-hover padding-6 pt-40 mt-20">
                <img src="/img/risk_managment/info_card_2.svg" alt="" />
                <h5 className="risk-color fs-20 ff-risk-pri fw-800 flh-26 mt-30">
                  Third Party <br />
            ...
            <div className="col-xxl-3 col-md-6">
              <div className="risk-info-card ca-two-border ca-two-border-color rounded-8 risk-border-hover padding-6 pt-40 mt-20">
                <img src="/img/risk_managment/info_card_3.svg" alt="" />
                <h5 className="risk-color fs-20 ff-risk-pri fw-800 flh-26 mt-30">
                  Financial
                  <br />
            ...
            <div className="col-xxl-3 col-md-6">
              <div className="risk-info-card ca-two-border ca-two-border-color rounded-8 risk-border-hover padding-6 pt-40 mt-20">
                <img src="/img/risk_managment/info_card_4.svg" alt="" />
                <h5 className="risk-color fs-20 ff-risk-pri fw-800 flh-26 mt-30">
                  Compliance
                  <br />
                  <span className="risk-bg-color"></span>Management
