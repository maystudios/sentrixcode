  ...
  return (
    <>
      <div className="rm-service-area risk-bg-color-two pt-120 position-relative">
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="position-relative">
                <img
                  src="/img/risk_managment/service.png"
                  alt=""
                  className="rm-service-img img-fluid"
                />
                <img
                  src="/img/risk_managment/shape/service.png"
                  alt=""
        ...
        <img
          src="/img/risk_managment/shape/service_2.png"
          alt=""
          className="s-two position-absolute"
        />
        <img
          src="/img/risk_managment/shape/service_3.png"
          alt=""
