      ...
      <div className="rm-hero pt-120 pb-120 position-relative overflow-hidden">
        <div className="container">
          <div className="position-relative">
            <div className="row align-items-center justify-content-between">
              <div className="col-lg-6">
                <h1 className="rm-hero-title text-white fs-72 fw-800 ff-risk-pri mb-20">
                  ...
                  <span>
                    <img src="/img/risk_managment/font.png" alt="" />
                  </span>
                </h1>
                ...
                <div className="risk-customer-area mt-60">
                  ...
                  <div className="risk-customer-logo-wrapper d-flex align-items-center gap-10 flex-wrap">
                    <img
                      ...
                      src="/img/risk_managment/customer.png"
                      alt=""
                    />
                    <img
                      className="risk-customer-logo"
                      src="/img/risk_managment/customer_2.png"
                      alt=""
                    />
                    <img
                      className="risk-customer-logo"
                      src="/img/risk_managment/customer_3.png"
                      alt=""
                    />
                    <img
                      className="risk-customer-logo"
                      src="/img/risk_managment/customer_4.png"
                      alt=""
                    />
                  </div>
                </div>
              ...
              <div className="col-lg-5 col-md-8">
                <div className="position-relative">
                  <img
                    src="/img/risk_managment/hero.png"
                    alt=""
            ...
            <img
              src="/img/risk_managment/shape/hero.png"
              alt=""
