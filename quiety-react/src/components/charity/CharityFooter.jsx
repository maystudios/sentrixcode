...
const CharityFooter = () => {
  return (
    <>
      <footer className="footer-40 bg-brand-39">
        <div className="container-fluid">
          <div className="bg-brand-39 ptb-120 rounded-3">
            <div className="container">
              <div className="d-flex align-items-center gap-4 pb-60">
                <h2 className="text-white fs-64 mb-0">Let’s Contact</h2>
                <a href="#" className="btn-38-style">
                  <span class="hover-style ma-warning-bg">
                ...
                <div className="col-md-12 col-lg-7 mt-4 mt-md-0 mt-lg-0">
                  <div className="row">
                    <div className="col-md-4 col-lg-4 mt-4 mt-md-0 mt-lg-0">
                      <div className="footer-single-col">
                        <h3 className="text-white">Primary Pages</h3>
                        <ul className="list-unstyled footer-nav-list mb-lg-0">
                          {footerPrimaryPages.map((primaryPage, i) => (
                            <li key={i + 1}>
                              <Link
                                className="text-decoration-none text-white opacity-100"
                                to={primaryPage.href}
                              >
                                {primaryPage.title}
                              </Link>
                    ...
                    <div className="col-md-4 col-lg-4 mt-4 mt-md-0 mt-lg-0">
                      <div className="footer-single-col">
                        <h3 className="text-white">Template</h3>
                        <ul className="list-unstyled footer-nav-list mb-lg-0">
          ...
          <div className="py-4 text-center">
            <p className="text-white mb-0">
              ...
              <a className="home-38-color-brand-900 fw-700" href="#">
                ThemeTags
              </a>
            </p>
          </div>
