...
const ItCompanyFooter = () => {
  return (
    <>
      <div className="it-company-footer it-company-bg-two pt-120 position-relative z-1">
        <div className="rm-footer-top">
          <div className="container">
            <div className="row justify-content-between">
              <div className="col-xl-3 col-lg-5">
                <div className="footer-single-col">
                  <img src="/img/it_company/logo.png" alt="" />
                  ...
                  <ul className="list-unstyled list-inline footer-social-list d-flex mb-0">
                    <li className="list-inline-item">
                      <Link href="/it-company" className="bgc-white risk-color">
              ...
              <div className="col-xl-3 col-lg-5">
                <div className="footer-single-col pl-40">
                  ...
                  <ul className="list-unstyled footer-nav-list mb-lg-0">
                    <li>
                      <Link href="/it-company" className="text-decoration-none">
                        Pricing
                      </Link>
                    </li>
                    <li>
              ...
              <div className="col-xl-3 col-lg-5">
                <div className="footer-single-col pr-20">
                  ...
                  <ul className="list-unstyled footer-nav-list mb-lg-0">
                    ...
                    <li className="mt-30">
                      <Link href="/it-company" className="">
                        View Google Map
                      </Link>
                    </li>
                  </ul>
        ...
        <div className="rm-footer-bottom text-center pt-80 pb-30">
          <p className="it-company-color fs-16 ff-risk-pri flh-24 mb-0">
            ...
            <Link className="it-company-color fw-700" href="/">
              ThemeTags
            </Link>
          </p>
        </div>
