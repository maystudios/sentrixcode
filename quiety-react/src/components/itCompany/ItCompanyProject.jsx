                ...
                >
                  <SwiperSlide className="swiper-slide">
                    <div className="it-company-project-item position-relative rounded-10 overflow-hidden">
                      <img
                        src="/img/it_company/project.png"
                        alt="Project 1"
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="it-company-project-item position-relative rounded-10 overflow-hidden">
                      <img
                        src="/img/it_company/project_2.png"
                        alt="Project 2"
                        className="w-100 img-fluid"
                      />
                      <div className="it-company-project-content w-100 h-100 d-flex flex-column justify-content-end gap-4 pl-40 position-absolute">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="it-company-project-item position-relative rounded-10 overflow-hidden">
                      <img
                        src="/img/it_company/project_3.png"
                        alt="Project 3"
                        className="w-100 img-fluid"
                      />
                      <div className="it-company-project-content w-100 h-100 d-flex flex-column justify-content-end gap-4 pl-40 position-absolute">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="it-company-project-item position-relative rounded-10 overflow-hidden">
                      <img
                        src="/img/it_company/project_4.png"
                        alt="Project 4"
                        className="w-100 img-fluid"
                      />
                      <div className="it-company-project-content w-100 h-100 d-flex flex-column justify-content-end gap-4 pl-40 position-absolute">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="it-company-project-item position-relative rounded-10 overflow-hidden">
                      <img
                        src="/img/it_company/project_5.png"
                        alt="Project 5"
                        className="w-100 img-fluid"
                      />
                      <div className="it-company-project-content w-100 h-100 d-flex flex-column justify-content-end gap-4 pl-40 position-absolute">
