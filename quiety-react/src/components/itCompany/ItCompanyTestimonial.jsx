                  ...
                  >
                    <SwiperSlide className="swiper-slide">
                      <div className="sc-feedback-card bg-white rounded">
                        <img
                          src="/img/it_company/testimonial.png"
                          alt="Testimonial"
                          className="mb-4"
                        />
                        ...
                        <div className="d-flex align-items-center">
                          <img
                            src="/img/it_company/testimoniala.png"
                            alt="Client"
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="sc-feedback-card bg-white rounded">
                        <img
                          src="/img/it_company/testimonial_2.png"
                          alt="Testimonial"
                          className="mb-4"
                        />
                        <p className="clr-paragraph fs-16 fw-500 flh-24 mb-30">
                        ...
                        <div className="d-flex align-items-center">
                          <img
                            src="/img/it_company/testimoniala_2.png"
                            alt="Client"
                            className="rounded-circle flex-shrink-0"
                          />
                          <div className="ms-4">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="sc-feedback-card bg-white rounded">
                        <img
                          src="/img/it_company/testimonial_3.png"
                          alt="Testimonial"
                          className="mb-4"
                        />
                        <p className="clr-paragraph fs-16 fw-500 flh-24 mb-30">
                        ...
                        <div className="d-flex align-items-center">
                          <img
                            src="/img/it_company/testimoniala_3.png"
                            alt="Client"
                            className="rounded-circle flex-shrink-0"
                          />
                          <div className="ms-4">
