...
import { insuranceBrands } from "../../data";
...
const InsuranceService = () => {
  ...
  return (
    <section className="ins-service-section pb-120 bg-light-subtle">
        ...
        <div className="mt-5">
          <div className="row justify-content-center g-4">
            ...
            <div className="col-xl-4 col-lg-6">
              <div className="ins-service-card text-center py-5 px-4 bg-white rounded-1">
                <img
                  src="/img/icons/ins-2.svg"
                  alt="icon"
                  className="img-fluid"
                />
                <Link href="/single-service">
                  <h5 className="mt-4 mb-3 ins-heading">Business Insurance</h5>
                </Link>
                <p className="mb-4 ins-text">
                  Competently seize performance based growth multidisciplinary
                  total linkage. change for customized e-services applications.
