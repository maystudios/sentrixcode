...
import { insuranceGallery } from "../../data";
...
const InsuranceGallery = () => {
  ...
  return (
    <section className="ins-gallery bg-light-subtle">
          ...
          <div className="col-xl-5">
            <div className="ins-gallery-info mt-3 mt-xl-0">
              ...
              <div className="d-flex align-items-center ins-gallery-info-btns flex-wrap">
                <Link className="ins-btn ins-secondary-btn" href="/contact-us">
                  Get a Quote
                  <span className="ms-1">
                    <svg
                      width="22"
...
export default InsuranceGallery;
