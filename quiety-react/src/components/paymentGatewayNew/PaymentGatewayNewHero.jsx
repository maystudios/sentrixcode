  ...
  return (
    <>
      <div className="pay-gw-hero-area pay-op-body-color ptb-120 position-relative z-1">
          ...
          <div className="row justify-content-between">
            <div className="col-lg-6">
              <h1 className="pay-gw-hero-title pay-gw-color fs-72 ff-risk-pri mb-60">
                ...
                <span>
                  <img
                    src="/img/home_34/hero-title.png"
                    alt=""
                    className="img-fluid"
                  />
                </span>{" "}
              ...
              <img
                src="/img/home_34/hero-1.png"
                alt=""
                className="img-fluid d-block mb-60"
              />
              <img
                src="/img/home_34/hero-2.png"
                alt=""
                className="img-fluid d-block mb-60"
              />
              <img
                src="/img/home_34/hero-logo-1.png"
                alt=""
            ...
            <div className="col-xl-5 col-lg-6">
              <div className="pay-gw-hero-img-box">
                <div className="text-end mb-20">
                  <img
                    src="/img/home_34/hero-list-2.png"
                    alt=""
                    className="img-fluid"
                  />
                </div>
                <img
                  src="/img/home_34/hero-list-1.png"
                  alt=""
                  className="img-fluid"
                />
                <div className="text-end mb-30">
                  <img
                    src="/img/home_34/hero-logo-5.png"
                    alt=""
              ...
              <div className="d-flex align-items-center justify-content-start justify-content-xl-end flex-wrap gap-4">
                <img
                  src="/img/home_34/hero-logo-2.png"
                  alt=""
                  className="img-fluid"
                />
                <img
                  src="/img/home_34/hero-logo-3.png"
                  alt=""
                  className="img-fluid"
                />
                <img
                  src="/img/home_34/hero-logo-4.png"
                  alt=""
                  className="img-fluid"
                />
              </div>
        ...
        <img
          src="/img/home_34/hero-mobile.png"
          alt=""
