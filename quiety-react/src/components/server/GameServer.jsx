            ...
            <div className="game-card">
              ...
              <div className="card-bottom">
                <Link to="/" className="d-flex justify-content-between">
                  ...
                  <img src="/img/server/arrows.svg" alt="" />
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-7">
            <div className="game-server-lists d-flex align-items-center justify-content-between">
              <div className="d-none d-md-block">
                <img src="/img/server/c-arrow.png" alt="shape" />
              </div>
              <ul className="list-unstyled d-flex game-img">
                <li>
                  <Link to="/">
                    <img src="/img/server/e1.png" alt="game" />
                  </Link>
                </li>
                <li>
                  <Link to="/">
                    {" "}
                    <img src="/img/server/e2.png" alt="game" />
                  </Link>
                </li>
                <li>
                  <Link to="/">
                    <img src="/img/server/e3.png" alt="game" />
                  </Link>
                </li>
                <li>
                  <Link to="/">
                    <img src="/img/server/e4.png" alt="game" />
                  </Link>
                </li>
              </ul>
