                  ...
                  >
                    <SwiperSlide>
                      <div className="ca-two-product-item bg-white ca-two-border ca-two-border-color rounded-16 padding-6 pt-40 mt-20">
                        <img
                          src="/img/creative-agency-2/product.png"
                          alt="Product 1"
                    ...
                    <SwiperSlide>
                      <div className="ca-two-product-item bg-white ca-two-border ca-two-border-color rounded-16 padding-6 pt-40 mt-20">
                        <img
                          src="/img/creative-agency-2/product_2.png"
                          alt="Product 2"
                          className="ca-two-product-img"
                        />
                        <h5 className="ca-two-body-clr-two fs-20 mb-20 mt-20">
                    ...
                    <SwiperSlide>
                      <div className="ca-two-product-item bg-white ca-two-border ca-two-border-color rounded-16 padding-6 pt-40 mt-20">
                        <img
                          src="/img/creative-agency-2/product_3.png"
                          alt="Product 3"
                          className="ca-two-product-img"
                        />
                        <h5 className="ca-two-body-clr-two fs-20 mb-20 mt-20">
                    ...
                    <SwiperSlide>
                      <div className="ca-two-product-item bg-white ca-two-border ca-two-border-color rounded-16 padding-6 pt-40 mt-20">
                        <img
                          src="/img/creative-agency-2/product_4.png"
                          alt="Product 4"
                          className="ca-two-product-img"
                        />
                        <h5 className="ca-two-body-clr-two fs-20 mb-20 mt-20">
                    ...
                    <SwiperSlide>
                      <div className="ca-two-product-item bg-white ca-two-border ca-two-border-color rounded-16 padding-6 pt-40 mt-20">
                        <img
                          src="/img/creative-agency-2/product_5.png"
                          alt="Product 5"
                          className="ca-two-product-img"
                        />
                        <h5 className="ca-two-body-clr-two fs-20 mb-20 mt-20">
