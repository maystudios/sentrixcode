        ...
        <div className="container-fluid">
          <div className="container p-0">
            <div className="position-relative">
              <img
                src="/img/creative-agency-2/shape/1.png"
                alt=""
              ...
              <div className="row">
                <div className="col-lg-12">
                  <img
                    src="/img/creative-agency-2/hero.png"
                    alt=""
                      ...
                      >
                        <SwiperSlide>
                          <div className="single-logo">
                            <img
                              src="/img/creative-agency-2/logo.png"
                              className="img-fluid"
                              height="30"
                              alt="logo"
                            />
                        ...
                        <SwiperSlide>
                          <div className="single-logo">
                            <img
                              src="/img/creative-agency-2/logo_2.png"
                              className="img-fluid"
                              height="30"
                              alt="logo"
                            />
                        ...
                        <SwiperSlide>
                          <div className="single-logo">
                            <img
                              src="/img/creative-agency-2/logo_3.png"
                              className="img-fluid"
                              height="30"
                              alt="logo"
                            />
                        ...
                        <SwiperSlide>
                          <div className="single-logo">
                            <img
                              src="/img/creative-agency-2/logo_4.png"
                              className="img-fluid"
                              height="30"
                              alt="logo"
                            />
                        ...
                        <SwiperSlide>
                          <div className="single-logo">
                            <img
                              src="/img/creative-agency-2/logo_5.png"
                              className="img-fluid"
                              height="30"
                              alt="logo"
                            />
