...
const logos = [
  { src: "/img/creative-agency-2/logo.png", alt: "Logo 1" },
  { src: "/img/creative-agency-2/logo_2.png", alt: "Logo 2" },
  { src: "/img/creative-agency-2/logo_3.png", alt: "Logo 3" },
  { src: "/img/creative-agency-2/logo_4.png", alt: "Logo 4" },
  { src: "/img/creative-agency-2/logo_5.png", alt: "Logo 5" },
  { src: "/img/creative-agency-2/logo_3.png", alt: "Logo 3" },
];
        ...
        <div className="ai-wt-hero-area pl-20 pr-20">
          <div className="container-fluid">
            <div className="ai-wt-hero ai-wt-bg pt-160 pb-40 rounded-3 position-relative z-1 overflow-hidden">
              ...
              <img
                src="/img/ai-wt-home/shape/hero-1.png"
                alt="Hero Shape 1"
                className="shape-1 img-fluid position-absolute left-0 top-0 z--1"
              />
              <img
                src="/img/ai-wt-home/shape/hero-2.png"
                alt="Hero Shape 2"
