...
const logos = [
  { src: "/img/brand-logo/google.svg", alt: "Google logo" },
  { src: "/img/brand-logo/facebook.svg", alt: "Facebook logo" },
  { src: "/img/brand-logo/youtube.svg", alt: "YouTube logo" },
  { src: "/img/brand-logo/printerest.svg", alt: "Printerest logo" },
  { src: "/img/brand-logo/webflow.svg", alt: "Webflow logo" },
  { src: "/img/brand-logo/company.svg", alt: "Company logo" },
];
