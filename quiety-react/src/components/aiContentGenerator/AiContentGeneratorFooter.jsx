...
const AiContentGeneratorFooter = () => {
  return (
    <>
      <div className="aih-footer ail-footer bgc-dark-1 pt-160">
        <div className="aih-footer-top">
          <div className="container">
            <div className="row justify-content-between">
              <div className="col-xl-3 col-lg-5">
                <div className="footer-single-col">
                  <img src="/img/ai_home/logo.png" alt="" />
              ...
              <div className="col-xl-3 col-lg-5">
                <div className="footer-single-col pr-20">
                  ...
                  <ul className="list-unstyled footer-nav-list mb-lg-0">
                    ...
                    <li className="mt-30">
                      <Link href="/ai-content-generator" className="">
                        View Google Map
                      </Link>
                    </li>
                  </ul>
...
export default AiContentGeneratorFooter;
