  ...
  return (
    <section>
      <div className="container">
        <div className="ev-schedule mt--50 ptb-100 rounded-top bg-light-subtle">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="tab-content" id="pills-tabContent">
                ...
                >
                  <div className="single-eve-session bg-white py-5 rounded px-4 px-lg-0 mb-4">
                    <div className="row align-items-center">
                      <div className="col-lg-3">
                        <div className="text-lg-center speaker-info mb-3 mb-lg-0 py-3 md-py-0">
                          <img
                            src="/img/event/sp-1.png"
                            alt="speaker"
                            className="mb-3"
                          />
                  ...
                  <div className="single-eve-session py-5 bg-white rounded px-4 px-lg-0 mb-4">
                    <div className="row align-items-center">
                      <div className="col-lg-3">
                        <div className="text-lg-center speaker-info mb-3 mb-lg-0 py-3 md-py-0">
                          <img
                            src="/img/event/sp-2.png"
                            alt="speaker"
                            className="mb-3"
                          />
