...
export default function EventAbout() {
  return (
    <section
      ...
      style={{
        background:
          "url('/img/event/about-bg.jpg')no-repeat center center/cover",
      }}
    >
      <div className="container">
        <div className="row align-items-center">
          <div className="col-lg-6 col-md-12">
            <div className="ev-ab-img position-relative ms-0 ms-lg-5">
              <img
                src="/img/event/about-img-1.png"
                className="img-fluid z-5 position-relative"
                alt="men"
              />
              <img
                src="/img/event/about-img-2.png"
        ...
        <ul className="elements list-unstyled d-none d-xl-block">
          <li>
            <img src="/img/event/star.png" alt="star" />
          </li>
          <li>
            <img
              src="/img/event/human-shape.png"
              className="img-fluid"
              alt="human"
            />
          </li>
