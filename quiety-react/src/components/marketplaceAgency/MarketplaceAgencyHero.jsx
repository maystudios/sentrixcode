  ...
  return (
    <>
      <section className="marketplace-agency bg-light-subtle pt-200 position-relative">
        <img
          src="/img/home_37/ma-hero-bg.png"
          alt="image"
        ...
        <div className="pt-60">
          <div className="position-relative">
            ...
            <img
              src="/img/home_37/hero-slide-shape-1.png"
              alt="image"
              className="img-fluid position-absolute top-0 end-0 h-100 pe-none"
            />
            <img
              src="/img/home_37/hero-slide-shape-2.png"
              alt="image"
                    ...
                    <SwiperSlide>
                      <div className="position-relative">
                        ...
                        <div className="text-end">
                          <img
                            src="/img/home_37/hero-slide-1.png"
                            alt="image"
