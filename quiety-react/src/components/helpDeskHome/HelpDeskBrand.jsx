...
const HelpDeskBrand = () => {
  const brands = [
    { src: "/img/icons/monday.png", alt: "monday" },
    { src: "/img/icons/segment.png", alt: "segment" },
    { src: "/img/icons/samsung.png", alt: "samsung" },
    { src: "/img/icons/morpheus.png", alt: "morpheus" },
    { src: "/img/icons/hellosign.png", alt: "hellosign" },
    { src: "/img/icons/getaround.png", alt: "getaround" },
    { src: "/img/icons/northwest.png", alt: "northwest" },
    { src: "/img/icons/lattice.png", alt: "lattice" },
  ];
  return (
    <>
