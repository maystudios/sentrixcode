    ...
    <>
      {isClient && (
        <div className="aiart-post-area ptb-120 position-relative z-1">
          <img
            src="/img/aiart_home/shape/ps-1.png"
            alt=""
            className="shape-1 position-absolute top-0 left-0 z--1"
          />
          <img
            src="/img/aiart_home/info-bg.png"
            alt=""
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6">
                <div className="text-lg-end">
                  <Link to="request-demo" className="btn btn-primary rounded-5">
                    See All AI Tools
                  </Link>
                </div>
              </div>
