  ...
  return (
    <>
      <div className="section-space bg-design-agency-about position-relative">
        <img
          src="/img/design-agency/d_show_shape.png"
          alt=""
          className="position-absolute shape_one"
        />
        <img
          src="/img/design-agency/d_show_shape_2.png"
          alt=""
          className="position-absolute shape_two"
        />
        <img
          src="/img/design-agency/d_show_shape_3.png"
          alt=""
          className="position-absolute shape_three"
        />
        <img
          src="/img/design-agency/d_show_shape_4.png"
          alt=""
          ...
          <div className="row g-4">
            <div className="col-md-6 col-lg-4 col-xxl-5">
              <div className="showcase-card showcase-custom">
                <img
                  src="/img/design-agency/showcase.png"
                  alt="image"
            ...
            <div className="col-md-6 col-lg-4 col-xxl-3">
              <div className="showcase-card showcase-custom">
                <img
                  src="/img/design-agency/showcase2.png"
                  alt="image"
                  className="img-fluid w-100 h-100"
                />
                <div className="showcase-card__content padding-6 rounded-4 bgc-white">
            ...
            <div className="col-md-6 col-lg-4 col-xxl-4">
              <div className="showcase-card showcase-custom">
                <img
                  src="/img/design-agency/showcase3.png"
                  alt="image"
                  className="img-fluid w-100 h-100"
                />
                <div className="showcase-card__content padding-6 rounded-4 bgc-white">
            ...
            <div className="col-md-6 col-lg-4 col-xxl-3">
              <div className="showcase-card showcase-custom">
                <img
                  src="/img/design-agency/showcase4.png"
                  alt="image"
                  className="img-fluid w-100 h-100"
                />
                <div className="showcase-card__content padding-6 rounded-4 bgc-white">
            ...
            <div className="col-md-6 col-lg-4 col-xxl-5">
              <div className="showcase-card showcase-custom">
                <img
                  src="/img/design-agency/showcase5.png"
                  alt="image"
                  className="img-fluid w-100 h-100"
                />
                <div className="showcase-card__content padding-6 rounded-4 bgc-white">
            ...
            <div className="col-md-6 col-lg-4 col-xxl-4">
              <div className="showcase-card showcase-custom">
                <img
                  src="/img/design-agency/showcase6.png"
                  alt="image"
                  className="img-fluid w-100 h-100"
                />
                <div className="showcase-card__content padding-6 rounded-4 bgc-white">
