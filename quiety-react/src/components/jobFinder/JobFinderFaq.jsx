  ...
  return (
    <div>
      <div className="container-fluid">
        <div className="payment_wrapper home-38-bg-brand-20 ptb-120 rounded-3 position-relative z-2">
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-6">
                <div className="text-center mb-30">
                  <h2 className="home-38-title fs-48 mb-1">
          ...
          <img
            src="/img/home_38/faq_bg.png"
            alt="Image"
            className="img-fluid position-absolute bottom-0 end-0 z-n1 d-none d-lg-block"
          />
        </div>
      </div>
    </div>
