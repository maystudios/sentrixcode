...
const JobFinderFooter = () => {
  return (
    <>
      <footer className="footer-38">
        <div className="container-fluid">
          <div className="bg-dark ptb-120 rounded-3">
            <div className="container">
              <div className="d-flex align-items-center gap-4 pb-60">
                ...
                <a href="#" className="btn-38-style">
                  <span className="hover-style home-38-bg-brand">
...
export default JobFinderFooter;
