  ...
  return (
    <>
      <section className="dg-about-section pt-120 bg-white position-relative z-1">
        <img
          src="/img/digital-agency/ab-shadow-shape.png"
          alt="shadows"
          ...
          <div className="row g-4 justify-content-between">
            <div className="col-xl-5 col-lg-6">
              <div className="dg-about-left pe-4">
                <img
                  src="/img/digital-agency/ab-1.jpg"
                  alt="About"
            ...
            <div className="col-xl-7 col-lg-6">
              <div className="dg-about-right ps-lg-4">
                ...
                <div className="dg-about-bottom position-relative mt-70">
                  <img
                    src="/img/digital-agency/ab-shape-box.jpg"
                    alt="not found"
                    className="rounded-3 shape-box"
                  />
                  <img
                    src="/img/digital-agency/ab-2.jpg"
                    alt="not found"
                    className="rounded-4 img-fluid"
                  />
                </div>
        ...
        <img
          src="/img/digital-agency/doted-line-left.png"
          alt="doted line"
          className="position-absolute start-0 bottom-0 z--1"
        />
        <img
          src="/img/digital-agency/doted-line-right.png"
          alt="doted line"
