            ...
            >
              <SwiperSlide className="dg-portfolio-single bg-white rounded">
                <div className="thunbmanil overflow-hidden rounded-top mb-4">
                  <Link href="/digital-agency">
                    <img
                      src="/img/digital-agency/p-1.jpg"
                      className="img-fluid"
              ...
              <SwiperSlide className="dg-portfolio-single bg-white rounded">
                <div className="thunbmanil overflow-hidden rounded-top mb-4">
                  <Link href="/digital-agency">
                    <img
                      src="/img/digital-agency/p-2.jpg"
                      className="img-fluid"
              ...
              <SwiperSlide className="dg-portfolio-single bg-white rounded">
                <div className="thunbmanil overflow-hidden rounded-top mb-4">
                  <a href="#">
                    <img
                      src="/img/digital-agency/p-3.jpg"
                      className="img-fluid"
