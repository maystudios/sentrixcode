            ...
            <div className="col-xl-7 col-lg-6">
              ...
              >
                <SwiperSlide className="dg-team-single rounded-3 position-relative overflow-hidden">
                  <img
                    src="/img/digital-agency/team-1.jpg"
                    alt="team"
                    className="img-fluid"
                  />
                ...
                <SwiperSlide className="dg-team-single rounded-3 position-relative overflow-hidden">
                  <img
                    src="/img/digital-agency/team-2.jpg"
                    alt="team"
                    className="img-fluid"
                  />
                  <div className="designation-box bg-white rounded-3 text-center">
                ...
                <SwiperSlide className="dg-team-single rounded-3 position-relative overflow-hidden">
                  <img
                    src="/img/digital-agency/team-3.jpg"
                    alt="team"
                    className="img-fluid"
                  />
                  <div className="designation-box bg-white rounded-3 text-center">
