          ...
          <div className="row align-items-center justify-content-between">
            <div className="col-xl-4 col-lg-7">
              <div className="mk-feature-content">
                ...
                <Link href="/services" className="mk-explore-btn fw-bold">
                  Explore More
                  <span className="ms-1">
                    <svg
                      width="53"
            ...
            <div className="col-xl-7">
              <div className="mk-feature-dashboard position-relative mt-5 mt-xl-0">
                <img
                  src="/img/shape/mk-doted.png"
                  alt="doted"
                  className="position-absolute mk-feature-dot"
                />
                <img
                  src="/img/marketing/feature-dashboard.svg"
                  alt="dashboard"
                  className="img-fluid"
                />
              </div>
...
export default SassMarketingFeature;
