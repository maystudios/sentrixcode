...
const SassMarketingSubscription = () => {
  return (
    <section className="mk-subscribe bg-white overflow-hidden ptb-120">
      <div className="container">
        <div className="mk-subscribe-box position-relative rounded bg-light-subtle">
          <img
            src="/img/shape/sb-wave-top.png"
            alt="wave shape"
            className="position-absolute sb-shape end-50 top-0"
          />
          <img
            src="/img/shape/sb-circle-half.png"
            alt="circle"
          ...
          <img
            src="/img/marketing/sb-object.png"
            alt="object"
...
export default SassMarketingSubscription;
