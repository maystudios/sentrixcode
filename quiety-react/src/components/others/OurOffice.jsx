        ...
        <div className="row">
          <div className="col-lg-3 col-md-6 mt-4 mt-lg-0 mt-xl-0">
            <div
              ...
              style={{
                background:
                  "url('/img/office-img-1.jpg')no-repeat center center / cover",
              }}
            >
          ...
          <div className="col-lg-3 col-md-6 mt-4 mt-lg-0 mt-xl-0">
            <div
              ...
              style={{
                background:
                  "url('/img/office-img-2.jpg')no-repeat center center / cover",
              }}
            >
              <div className="office-content text-center p-4">
                <span className="office-overlay"></span>
          ...
          <div className="col-lg-3 col-md-6 mt-4 mt-lg-0 mt-xl-0">
            <div
              ...
              style={{
                background:
                  "url('/img/office-img-3.jpg')no-repeat center center / cover",
              }}
            >
              <div className="office-content text-center p-4">
                <span className="office-overlay"></span>
          ...
          <div className="col-lg-3 col-md-6 mt-4 mt-lg-0 mt-xl-0">
            <div
              ...
              style={{
                background:
                  "url('/img/office-img-5.jpg')no-repeat center center / cover",
              }}
            >
              <div className="office-content text-center p-4">
                <span className="office-overlay"></span>
