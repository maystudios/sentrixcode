          ...
          <div className="col-lg-6">
            <div className="benifits-left position-relative mb-5">
              ...
              <ul className="list-unstyled bi-right-shape">
                <li>
                  <img src="/img/bi-shape.png" alt="shape" />
                </li>
                <li>
                  <img src="/img/bi-shape-2.png" alt="shape" />
                </li>
                <li>
                  <img src="/img/bi-shape-3.png" alt="shape" />
                </li>
                <li>
                  <img src="/img/bi-pink-dot.png" alt="shape" />
                </li>
              </ul>
            </div>
          </div>
