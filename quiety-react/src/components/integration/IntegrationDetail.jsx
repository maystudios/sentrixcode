            ...
            <div className="col-lg-8 pe-5">
              <div className="integration-details-wrap">
                ...
                <p>
                  ...
                  procedures. Seamlessly parallel task open-source content
                ...
                <blockquote className="bg-white custom-shadow p-5 mt-5 rounded-custom border-4 border-primary border-top">
                  <p className="text-muted">
                    ...
                    cross-platform communities with backend markets. Assertively
                    utilize business services through robust solutions.
                    Rapidiously deliver cross-unit infrastructures rather than
                    accurate metrics.
