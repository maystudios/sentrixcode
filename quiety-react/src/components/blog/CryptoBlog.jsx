        ...
        <div className="row">
          <div className="col-lg-4 col-md-6">
            <div className="crypto-blog-card bg-soft-black mb-30 mb-lg-0">
              <div className="blog-thumb">
                <Link to="/blog-single">
                  <img src="/img/cbl-1.png" className="img-fluid" alt="thumb" />
                </Link>
              </div>
              ...
              <div className="author-meta d-flex align-items-center py-4">
                <div className="pe-3">
                  <img src="/img/testimonial/app-testimonial-1.png" alt="" />
                </div>
                <div>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="crypto-blog-card bg-soft-black mb-30 mb-lg-0">
              <div className="blog-thumb">
                <Link to="/blog-single">
                  <img src="/img/cbl-2.png" className="img-fluid" alt="thumb" />
                </Link>
              </div>
              <h3 className="h4 fw-medium">
                <Link
              ...
              <div className="author-meta d-flex align-items-center py-4">
                <div className="pe-3">
                  <img src="/img/testimonial/app-testimonial-3.png" alt="" />
                </div>
                <div>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="crypto-blog-card bg-soft-black">
              <div className="blog-thumb">
                <Link to="/blog-single">
                  <img src="/img/cbl-3.png" className="img-fluid" alt="thumb" />
                </Link>
              </div>
              <h3 className="h4 fw-medium">
                <Link
              ...
              <div className="author-meta d-flex align-items-center py-4">
                <div className="pe-3">
                  <img
                    src="/img/testimonial/app-testimonial-2.png"
                    alt="Noah"
                  />
                </div>
                <div>
