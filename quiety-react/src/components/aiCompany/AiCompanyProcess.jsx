const AiCompanyProcess = () => {
  return (
    <>
      <div className="aih-process-area ah-bg ptb-60">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-7">
              <div className="text-center">
                <h2 className="aih-title aih-color-two fs-48 fw-600 mb-40">
                  Our Working Process & How Do We Works{" "}
                </h2>
              </div>
            </div>
          </div>
              ...
              <div className="col-xl-3 col-lg-6">
                <div className="aih-process-item p-4 aih-border-style position-relative">
                  ...
                  <p className="ca-two-body-clr mt-20 mb-0">
                    To help you get started quickly and easily, we offer a
                    variety of pre-designed.
                  </p>
                </div>
              </div>
              <div className="col-xl-3 col-lg-6">
