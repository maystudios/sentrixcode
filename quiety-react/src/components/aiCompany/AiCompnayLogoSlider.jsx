...
const logos = [
  { src: "/img/brand-logo/google.svg", alt: "Google" },
  { src: "/img/brand-logo/facebook.svg", alt: "Facebook" },
  { src: "/img/brand-logo/youtube.svg", alt: "YouTube" },
  { src: "/img/brand-logo/printerest.svg", alt: "Pinterest" },
  { src: "/img/brand-logo/webflow.svg", alt: "Webflow" },
  { src: "/img/brand-logo/company.svg", alt: "Company" },
];
